        ...
        try (Scanner scanner = new Scanner(fileCSV)){
            while (scanner.hasNextLine()){
                ...
                if (dataFromCsvLine.length <= 7 ){
                    ...
                    Motorcycle motorcycle = new Motorcycle(dataFromCsvLine[0], dataFromCsvLine[1], Integer.parseInt(dataFromCsvLine[2]), Float.parseFloat(dataFromCsvLine[3]), Boolean.parseBoolean(dataFromCsvLine[4]), dataFromCsvLine[5], dataFromCsvLine[6], dataFromCsvLine[7]);
